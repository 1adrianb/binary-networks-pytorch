...
parser.add_argument('-data', metavar='DIR', default='/home/dev/data_main/imagenet_fast',
...
def main_worker(gpu, ngpus_per_node, args, logger):
    ...
    if args.optimizer == 'adamw':
        wd = args.weight_decay if args.step == 0 else 0 # TODO looks like we have to run each step separately
